...
if st.button("Uploading embeddings and process in pinecone"):
    ...
    st.success("Data has been uploaded as embeddings sucessfully")
else:
    st.warning("Please click on the button to start processing again")
